const PowerSettingsNewIcon = {
	...
	"content": "<svg viewBox=\"0 0 48 48\" xmlns=\"http://www.w3.org/2000/svg\" role=\"img\"><path d=\"M24 6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2s2-.9 2-2V8c0-1.1-.9-2-2-2zm10.28 5.72c-.78.78-.76 2-.02 2.78 2.26 2.4 3.66 5.6 3.74 9.14.18 7.66-6.16 14.26-13.82 14.34C16.36 38.1 10 31.8 10 24c0-3.68 1.42-7.02 3.74-9.52.74-.78.74-2-.02-2.76-.8-.8-2.1-.78-2.86.04-2.9 3.08-4.72 7.18-4.86 11.72-.28 9.76 7.66 18.2 17.42 18.5 10.2.32 18.58-7.86 18.58-18 0-4.74-1.84-9.02-4.84-12.22-.76-.82-2.08-.84-2.88-.04z\" fill=\"inherit\"/></svg>"
};
