...
const YduqsBeforeAfter = class {
  ...
  render() {
    return (index.h("div", { class: "c-before-after" }, index.h("div", { class: "row-ba pb-1" }, index.h("div", { class: "container-ba" }, index.h("div", { class: "wrapper" }, index.h("div", { class: "images" }, index.h("img", { class: "img1", src: this.after_img }), index.h("img", { class: "img2", src: this.before_img, style: { "clip": `rect(0px 0px auto 0px)` } })), index.h("div", { class: "slider" }, index.h("div", { class: "drag-line" }, index.h("span", null)), index.h("input", { type: "range", min: "0", max: "100", value: "50", onInput: this.changeImage }))), index.h("div", { class: "caption-before-after" }, index.h("p", { class: "c-before-after__caption u-text--small mt-2" }, this.caption))))));
  }
};
...
const Rating = class {
  ...
  render() {
    return (index.h("div", { class: "c-rating" }, index.h("h3", null, this.cta), index.h("div", { class: "star-rating" }, index.h("label", null, index.h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), index.h("label", null, index.h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), index.h("label", null, index.h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), index.h("label", null, index.h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), index.h("label", null, index.h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon))), this.dev ?
      index.h("script", { src: "https://stensineme.blob.core.windows.net/designsystem/test/yduqs_rating_dev.js" })
      : ''));
  }
};
