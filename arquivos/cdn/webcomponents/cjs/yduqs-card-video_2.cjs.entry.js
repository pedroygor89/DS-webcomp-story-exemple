...
const CardVideo = class {
  ...
  render() {
    ...
    return (index.h("div", { id: this.id_video, class: 'c-card-video ' + styleBorder }, index.h("div", { class: 'c-card-video__thumb ' + video_active }, index.h("yduqs-image", { src: this.thumb_video, alt: "" }), index.h("div", { class: "c-card-video__description_time" }, this.time)), index.h("div", { class: "c-card-video__description" }, index.h("p", { class: "c-paragraph c-card-video-module" }, parseInt(this.module_video) == 0 || this.module_video == 'todos'
      ...
      : parseInt(this.module_video) == 99 || this.module_video == 'apresentacao'
        ...
        : parseInt(this.module_video) == 100 || this.module_video == 'conclusao'
          ...
          : i18n.i18n('pager.modulo') + ' ' + this.module_video, ' ', "- ", this.type_video), index.h("h2", { class: "c-heading", innerHTML: this.title_video }), index.h("p", { class: "c-paragraph", innerHTML: this.paragraph }))));
  }
};
