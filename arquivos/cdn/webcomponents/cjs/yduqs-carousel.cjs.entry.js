...
const YduqsCarousel = class {
  ...
  render() {
    ...
    const controlLeft = (index.h("div", { class: `c-carousel-control c-carousel-control__left` }, index.h("div", { class: `c-carousel-control__button ${prevCtrlState}`, onClick: this.prev.bind(this) }, index.h("span", { class: "c-carousel-control__icon material-icons" }, this.template_doktor ? 'arrow_back' : 'chevron_left'))));
    const controlRight = (index.h("div", { class: `c-carousel-control c-carousel-control__right` }, index.h("div", { class: `c-carousel-control__button ${nextCtrlState}`, onClick: this.next.bind(this) }, index.h("span", { class: "c-carousel-control__icon material-icons" }, this.template_doktor ? 'arrow_forward' : 'chevron_right'))));
    const pages = (index.h("div", { class: `c-carousel-pages ${this.template_doktor && 'onlyMobile'}` }, index.h("div", { class: "c-carousel-pages__content" }, index.h("span", { class: `c-carousel-pages__icon material-icons ${prevCtrlState}`, onClick: this.prev.bind(this) }, this.template_doktor ? 'arrow_back' : 'chevron_left'), index.h("span", { class: "c-carousel-pages__container" }, this.currentPage, " ", this.english ? 'out of' : this.spanish ? 'de' : 'de', " ", this.allItems), index.h("span", { class: `c-carousel-pages__icon material-icons ${nextCtrlState}`, onClick: this.next.bind(this) }, this.template_doktor ? 'arrow_forward' : 'chevron_right'))));
    return (index.h("div", { class: `${background}` }, index.h("div", { class: `c-carousel ${mobileState}` }, controlLeft, index.h("div", { class: "carousel show" }, index.h("div", { ref: el => (this.content = el), class: "carousel__content", style: {
