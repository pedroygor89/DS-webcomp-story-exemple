      ...
      this.settings['modules'].forEach(module => {
        module.playlist.forEach(playlistItem => {
          ...
          if (this.module_number == '0' || this.module_number.replace('modulo_', '') == module.module.replace('modulo_', '')) {
            ...
            cardVideolist.push(index.h("yduqs-card-video", { id_video: playlistItem.id, module_video: module.module.replace('modulo_', ''), type_video: i18n.i18n('pager.teexplico'), title_video: playlistItem.title_video, subtitle_video: playlistItem.subtitle_video, thumb_video: playlistItem.thumb_video, link_video: playlistItem.link_video,
