...
const YduqsMotivationalMessages = class {
  ...
  _generateForwardIntervals() {
    ...
    this.forwardInterval = new Date().getTime() + (3 * 60 + utils.generateRandomNumber(1, 60)) * 1000;
  }
  /*
  ...
  */
  ...
  _showMessage(type) {
    ...
    const index = utils.generateRandomNumber(0, randomVector);
    this._setMessage({
      type: type,
      disclaimer: i18n.i18n(`motivationalMsg.${prefix}.${index}.disclaimer`) || undefined,
      icon: this.icons[i18n.i18n(`motivationalMsg.${prefix}.${index}.icon`)] || this.icons[this._getIcon(type)],
      title: i18n.i18n(`motivationalMsg.${prefix}.${index}.title`) || undefined,
      message: i18n.i18n(`motivationalMsg.${prefix}.${index}.message`),
    });
  }
  _hideMessage() {
    this.open = false;
  ...
  componentDidLoad() {
    ...
    $('body').on('click', 'yduqs-questions[question_id] button[question-reference]', (event) => {
      ...
      // Qual o tema?
      const theme = utils.cleanString(document.title).replace(/ +/g, '');
      // Qual o Módulo?
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("yduqs-alert", { usematerial: !Boolean((_a = this.message) === null || _a === void 0 ? void 0 : _a.icon), icon: ((_b = this.message) === null || _b === void 0 ? void 0 : _b.icon) || 'info', title: ((_c = this.message) === null || _c === void 0 ? void 0 : _c.disclaimer) || undefined, subtitle: ((_d = this.message) === null || _d === void 0 ? void 0 : _d.title) || undefined, message: (_e = this.message) === null || _e === void 0 ? void 0 : _e.message, btntext: i18n.i18n('globals.continuar'), open: this.open && Boolean(((_f = this.message) === null || _f === void 0 ? void 0 : _f.type) === 'alert') }), index.h("yduqs-confirm", { usematerial: !Boolean((_g = this.message) === null || _g === void 0 ? void 0 : _g.icon), icon: ((_h = this.message) === null || _h === void 0 ? void 0 : _h.icon) || 'info', title: i18n.i18n(`motivationalMsg.conclusion.disclaimer`), subtitle: ((_j = this.message) === null || _j === void 0 ? void 0 : _j.title) || undefined, message: (_k = this.message) === null || _k === void 0 ? void 0 : _k.message, btntext: i18n.i18n('motivationalMsg.conclusion.action'), open: this.open && Boolean(((_l = this.message) === null || _l === void 0 ? void 0 : _l.type) === 'confirm') }), index.h("yduqs-info", { usematerial: !Boolean((_m = this.message) === null || _m === void 0 ? void 0 : _m.icon), icon: ((_o = this.message) === null || _o === void 0 ? void 0 : _o.icon) || 'info', title: i18n.i18n(`motivationalMsg.conclusion.disclaimer`), subtitle: ((_p = this.message) === null || _p === void 0 ? void 0 : _p.title) || undefined, message: (_q = this.message) === null || _q === void 0 ? void 0 : _q.message, open: this.open && Boolean(((_r = this.message) === null || _r === void 0 ? void 0 : _r.type) === 'info') }), index.h("yduqs-toast", { usematerial: !Boolean((_s = this.message) === null || _s === void 0 ? void 0 : _s.icon), icon: ((_t = this.message) === null || _t === void 0 ? void 0 : _t.icon) || 'info', message: (_u = this.message) === null || _u === void 0 ? void 0 : _u.message, tit: (_v = this.message) === null || _v === void 0 ? void 0 : _v.title, open: this.open && Boolean(((_w = this.message) === null || _w === void 0 ? void 0 : _w.type) === 'toast') })));
  }
...
const YduqsPager = class {
  constructor(hostRef) {
    ...
    this.theme = utils.cleanString(document.title).replace(/ +/g, '');
  ...
  _setCurrentPage(value) {
    ...
    utils.dispatchEvent('yduqs-pager-before-change', { from: this.current, to: next, total: this.total });
    this.current = next;
  }
  _getCurrentPage() {
    return this.current;
