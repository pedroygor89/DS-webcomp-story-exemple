...
const YduqsOrderedDndChallenge = class {
  ...
  getResultThumb(item, index$1) {
    ...
    return (index.h("yduqs-feedback-thumb", { class: "item", feedback: result, image: item === null || item === void 0 ? void 0 : item.thumb }));
  }
  startTutorial() {
    this.showInfo = false;
    this.tutorialItem = 'chances';
  ...
  render() {
    ...
    index.h("i", { class: "material-icons active" }, index$1 + 1 === this.chances - this.usedChances && this.inCountdownDanger ? 'heart_broken' : 'favorite')) : (index.h("i", { class: "material-icons" }, "favorite_border")))), (this.step === 'tutorial' && this.tutorialItem === 'chances') && this.renderTip(`Você tem ${this.chances} tentativas`, 'bottom', undefined, () => this.handleNextTutorial('chances'))), !this.hideCount && (index.h("div", { class: "c-lab-game-header-item c-lab-game-tutorial-item c-lab-game-count" }, (_a = this.selecteds) === null || _a === void 0 ? void 0 :
      ...
      return index.h("img", { src: item.image, class: `preview ${isSelected ? '' : 'hide'}`, alt: "" });
    ...
    })))), this.step === _STEP_.FEEDBACK && (index.h("yduqs-modal", { variant: "lab", size: (this.showFeedback != 'positive' && ((_g = this.selecteds) === null || _g === void 0 ? void 0 : _g.length) > 0 && ((_h = this.selecteds) === null || _h === void 0 ? void 0 : _h.length) === this.sequence.length) ? 'large' : 'small', id: `${this._id}-feedback-modal`, isopen: true }, index.h("div", { class: "c-lab-game-modal-feedback" }, this.showFeedback === 'positive' ? (index.h(index.Fragment, null, index.h("div", { class: "content" }, index.h("yduqs-feedback-thumb", { class: "thumb", feedback: true, image: this.selecteds[0].image }), index.h("p", null, this.positiveFeedback)), index.h("footer", null, index.h("button", { type: "button", class: "c-button", onClick: () => this.handleCloseFeedback() }, "Continuar")))) : (index.h(index.Fragment, null, ((_j = this.selecteds) === null || _j === void 0 ? void 0 : _j.length) > 0 && ((_k = this.selecteds) === null || _k === void 0 ? void 0 : _k.length) === this.sequence.length ? (index.h(index.Fragment, null, index.h("div", { class: "content" }, index.h("p", null, (this.usedChances + 1 === this.chances) ? this.failFeedback : this.negativeFeedback)), index.h("div", { class: "result" }, this.selecteds.map((item, index) => this.getResultThumb(item, index))))) : (index.h("div", { class: "content" }, index.h("p", null, "Foi por pouco! Voc\u00EA n\u00E3o finalizou a atividade a tempo e perdeu uma tentativa."), " ")), index.h("footer", null, index.h("button", { type: "button", class: "c-button", onClick: () => this.handleCloseFeedback() }, (this.usedChances + 1 === this.chances) ? 'Voltar para Teoria' : 'Tentar outra vez'))))))))) : (index.h("yduqs-lab-error", { errors: this.error }))));
  }
};
