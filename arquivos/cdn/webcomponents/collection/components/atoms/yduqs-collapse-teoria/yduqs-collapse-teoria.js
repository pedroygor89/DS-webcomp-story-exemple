...
export class YduqsCollapseTeoria {
  constructor() {
    this.border = false;
    this.outline = false;
  }
  ...
  render() {
    ...
    return (h("div", { ref: (el) => (this.content = el), class: `C-collapse ${borderClass} ${outlineClass} ${activeClass}` },
      h("slot", null)));
  }
  static get is() { return "yduqs-collapse-teoria"; }
