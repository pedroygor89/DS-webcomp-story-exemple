import { Component, h, Host, State, Prop, Listen, Event, Method, Watch, Element } from '@stencil/core';
...
export class YduqsMenu {
    ...
    document.querySelectorAll('module').forEach((e, i) => {
      ...
      if (e.id !== 'apresentacao' && e.id !== 'conclusao') {
        menuItemsList.push(h("yduqs-accordion", { outline: false },
          h("yduqs-accordion-pane", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:jornada-' + e.id },
            ...
            h("div", { slot: "c-accordion-content" },
              e.querySelectorAll('yduqs-title, yduqs-questions, yduqs-teoria, yduqs-atividade-discursiva, .bgLigandoPontos').forEach((f, index) => {
                  ...
                  if (!skipMenu) {
                    menuSubItemsList.push(h("a", { class: {
                      ...
                      h("span", { class: {
                        ...
                        h("span", null, this.english ? 'Connecting the dots' : this.spanish ? 'Conectando los Puntos' : 'Ligando os Pontos'))));
                  }
                }
                    ...
                    if (!skipMenu) {
                      menuSubItemsList.push(h("a", { class: {
                        ...
                        h("span", { class: {
                          ...
                          h("span", { class: "material-icons" }, "create"),
                          h("span", null, this.english ? 'Discursive Activity' : this.spanish ? 'Actividad Discursiva' : 'Atividade Discursiva'))));
                    }
                  }
                }
              }),
        ...
        menuItemsList.push(h("a", { class: "menu-button", href: '#' + `${e.id}`, onClick: () => {
            ...
            this.closeMenu();
          }, "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:jornada-' + e.id },
    ...
    this.settings.modules.forEach((e, indexModule) => {
      ...
      if (modNum !== 'apresentacao' && modNum !== 'conclusao' && modNum !== 'introducao') {
            ...
            h("span", { class: "c-menu__item" },
              h("span", { class: "c-menu__item c-menu__item--active" },
                h("span", { class: "material-icons" },
                  " ",
                  videoOrPlaylist),
                h("span", { id: n.id, class: "c-menu__item-title", innerHTML: this.renderNameModule(n.title_video) })))));
        });
        menuItemsList.push(h("yduqs-accordion", { id: 'menu-accordion-video-' + indexModule, outline: false },
          h("yduqs-accordion-pane", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:video-' + modNum },
            h("span", { slot: "c-accordion-header", innerHTML: modNum == 'apresentacao' ? this.renderNameModule(i18n('pager.apresentacao')) : modNum == 'conclusao' ? this.renderNameModule(i18n('pager.conclusao')) : this.renderNameModule(i18n('pager.modulo') + ' ' + modNum) }, h("p", { class: "module-subtitle-menu", innerHTML: (this._titleModuloCover && this._titleModuloCover[indexModule - 1]) || '' })),
        ...
        if (e.playlist && e.playlist.length > 0) {
          menuItemsList.push(h("yduqs-accordion", { id: 'menu-accordion-video-' + indexModule, outline: false },
            h("yduqs-accordion-pane", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:video-' + modNum },
              h("span", { slot: "c-accordion-header", innerHTML: this.renderNameModule('Módulo ' + modNum) }),
              h("div", { slot: "c-accordion-content" }, ...menuSubItemsList))));
          let thisAcc = document.getElementById('menu-accordion-video-' + indexModule);
          if (menuSubItemsList.length === 0 && thisAcc !== null) {
            thisAcc.remove();
  ...
  renderMenuActivity() {
    ...
    document.querySelectorAll('module').forEach((e, accCount) => {
      ...
      if (e.id !== 'apresentacao' && e.id !== 'conclusao' && e.id !== 'introducao') {
        menuItemsActivity.push(h("yduqs-accordion", { id: 'menu-accordion-' + accCount, outline: false },
          h("yduqs-accordion-pane", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:atividade-' + e.id },
            h("span", { slot: "c-accordion-header", innerHTML: this.renderNameModule(e.id) }, h("p", { class: "module-subtitle-menu", innerHTML: (this._titleModuloCover && this._titleModuloCover[accCount - 1]) || '' })),
            h("div", { slot: "c-accordion-content" },
              e.querySelectorAll('yduqs-questions, yduqs-teoria, yduqs-atividade-discursiva, .bgLigandoPontos').forEach((f, index) => {
                let skipMenu = f.getAttribute('skip-menu');
                if (!skipMenu) {
                  if (f.classList.contains('bgLigandoPontos')) {
                    menuSubItemsList.push(h("a", { class: {
                      ...
                      h("span", { class: {
                        ...
                        h("span", { class: "material-icons" }, "create"),
                        h("span", null, this.english ? 'Connecting the dots' : this.spanish ? 'Relacionando los puntos' : 'Ligando os Pontos'))));
                  }
                  //Verifica se o elemento está dentro do ligando os pontos (Se estiver aparece apenas o item ligando os pontos no menu)
                  if (!f.closest('.bgLigandoPontos')) {
                    if (f.getAttribute('question_id')) {
      ...
      h("div", { class: "c-menu__modal" },
        ...
        h("div", { class: "c-menu__modal__body" },
          h("div", { class: "c-menu__modal__body__tab col-12" },
            h("yduqs-tabs", { fixed_titles: true, darkmode: false, outlined: false, icons: ['map', 'video_library', 'create'], gtm_category: [':[[instituicao]]:[[tipo-usuario]]', ':[[instituicao]]:[[tipo-usuario]]', ':[[instituicao]]:[[tipo-usuario]]'], gtm_action: ['menu:conteudo-clique-submenu', 'menu:conteudo-clique-submenu', 'menu:conteudo-clique-submenu'], gtm_label: ['jornada', 'videos', 'atividades'] },
              h("yduqs-tab", { header: headerJorney, open: true }, this.renderMenuJorney()),
              verifyVideos > 0 && (h("yduqs-tab", { header: headerMedia }, this.renderMenuMedia())),
              verifyAtividades > 0 && (h("yduqs-tab", { header: headerActivity }, this.renderMenuActivity()))))))));
  }
  animate(state = false) {
    this._animate = state;
  }
  ...
  getRenderDowloads() {
    ...
    document.querySelectorAll('yduqs-audio-player').forEach(podcast => {
      podcastItems.push(h("a", { class: "c-menu__item-container", "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": "download:download-podcast", href: podcast.src, download: true },
        h("span", { class: "c-menu__item" },
          h("span", { class: "c-menu__item" },
            h("span", { class: "material-icons" }, "mic"),
            h("span", { id: "resource" }, "Podcast"),
            h("span", { class: "material-icons icon-right" }, "file_download")))));
    });
    return (h("yduqs-accordion", { outline: false },
      h("yduqs-accordion-pane", null,
        h("span", { slot: "c-accordion-header" }, "Downloads"),
        h("div", { slot: "c-accordion-content" },
          ...podcastItems,
          h("a", { class: "c-menu__item-container", href: "javascript:CriaPDF()", "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": "download:download-pdf" },
            h("span", { class: "c-menu__item" },
              h("span", { class: "c-menu__item" },
                h("span", { class: "material-icons" }, "attachment"),
                h("span", { id: "resource" }, this.english ? 'Content PDF' : this.spanish ? 'Contenido PDF' : 'PDF do conteúdo'),
                h("span", { class: "icon-right material-icons" }, "file_download_done"))))))));
  }
  componentDidLoad() {
      ...
      h("div", { class: "c-menu__floating-btn__container" },
        h("button", { class: "c-menu__floating-btn", onClick: () => this.openMenu(), "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-menu", "data-gtm-event-label": "abrir-menu" },
          h("div", { class: `c-menu__floating-icon ${openIconClass}` },
            ...
            h("span", { class: "icon-bar" }),
            h("span", { class: "icon-bar" }))),
        !this.hide_search && h("yduqs-search-bar", null)),
      this.getMenuRender(),
