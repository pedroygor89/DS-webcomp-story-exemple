...
export default {
  title: 'Patterns/Footer Doktor',
  component: 'yduqs-footer-doktor',
  parameters: {
    markdown: readme
    //notes: readme,
  },
...
<!-- inicio footer-->
    <yduqs-footer-doktor btnimprimir="${btnImprimir}" hrefbtnprint="${hrefbtnprint}" namebtnimprimir="${nameBtnImprimir}">
