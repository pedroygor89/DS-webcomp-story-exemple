import front_notes_ds from './front-notes-ds.md';
import front_notes_legado from './front-notes-legado.md';
import { html } from 'lit-html';
export default {
  title: 'Patterns/Ligando os pontos',
  parameters: {
    markdown: front_notes_ds, front_notes_legado,
    notes: { 'Notas de Utilização DS': front_notes_ds, 'Notas de Utilização Legado': front_notes_legado },
  },
  argTypes: {
    placeholder: {
...
const BasicTemplate = ({ outline, background, placeholder, idTxt, idBtn, bgfeedbackdark, colunasmd, colunaslg }) => html `
    ...
    <section class="ligando-pontos bgLigandoPontos w-100">
        <div class="container">
