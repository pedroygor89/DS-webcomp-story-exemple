...
const PlaylistVideo = class {
  ...
  render() {
    ...
    return (h("div", { class: "c-card-video " + styleBorder }, h("div", { class: "c-card-video__thumb" }, h("yduqs-image", { src: this.thumb_video, alt: "Fuji-san" }), h("div", { class: "c-card-video__thumb_play" }, h("span", { class: "material-icons" }, "play_arrow"))), h("div", { class: "c-card-video__description" }, h("h2", { class: "c-heading" }, this.title_video), h("p", { class: "c-paragraph" }, this.paragraph), h("div", { class: "c-card-video__description_time" }, this.time))));
  }
};
