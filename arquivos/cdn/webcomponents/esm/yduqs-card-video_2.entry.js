...
const CardVideo = class {
  ...
  render() {
    ...
    return (h("div", { id: this.id_video, class: 'c-card-video ' + styleBorder }, h("div", { class: 'c-card-video__thumb ' + video_active }, h("yduqs-image", { src: this.thumb_video, alt: "" }), h("div", { class: "c-card-video__description_time" }, this.time)), h("div", { class: "c-card-video__description" }, h("p", { class: "c-paragraph c-card-video-module" }, parseInt(this.module_video) == 0 || this.module_video == 'todos'
      ? i18n('pager.todos')
