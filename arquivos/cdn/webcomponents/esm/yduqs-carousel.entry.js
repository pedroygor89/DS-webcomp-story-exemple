...
import { c as createCommonjsModule } from './_commonjsHelpers-47400be3.js';
...
const YduqsCarousel = class {
  ...
  render() {
    ...
    const controlLeft = (h("div", { class: `c-carousel-control c-carousel-control__left` }, h("div", { class: `c-carousel-control__button ${prevCtrlState}`, onClick: this.prev.bind(this) }, h("span", { class: "c-carousel-control__icon material-icons" }, this.template_doktor ? 'arrow_back' : 'chevron_left'))));
    const controlRight = (h("div", { class: `c-carousel-control c-carousel-control__right` }, h("div", { class: `c-carousel-control__button ${nextCtrlState}`, onClick: this.next.bind(this) }, h("span", { class: "c-carousel-control__icon material-icons" }, this.template_doktor ? 'arrow_forward' : 'chevron_right'))));
    const pages = (h("div", { class: `c-carousel-pages ${this.template_doktor && 'onlyMobile'}` }, h("div", { class: "c-carousel-pages__content" }, h("span", { class: `c-carousel-pages__icon material-icons ${prevCtrlState}`, onClick: this.prev.bind(this) }, this.template_doktor ? 'arrow_back' : 'chevron_left'), h("span", { class: "c-carousel-pages__container" }, this.currentPage, " ", this.english ? 'out of' : this.spanish ? 'de' : 'de', " ", this.allItems), h("span", { class: `c-carousel-pages__icon material-icons ${nextCtrlState}`, onClick: this.next.bind(this) }, this.template_doktor ? 'arrow_forward' : 'chevron_right'))));
    return (h("div", { class: `${background}` }, h("div", { class: `c-carousel ${mobileState}` }, controlLeft, h("div", { class: "carousel show" }, h("div", { ref: el => (this.content = el), class: "carousel__content", style: {
...
export { YduqsCarousel as yduqs_carousel };
