import { r as registerInstance, h, g as getElement, a as Host } from './index-b21d89aa.js';
...
const GalleryVideo = class {
  ...
  render() {
    return (h("div", { class: "c-gallery-video" }, h("div", { class: "c-gallery-video__header d-none d-lg-inline" }, h("h5", null, this.module_number_video == 0
      ? i18n('pager.todos')
      : this.module_number_video == 99
        ? i18n('pager.apresentacao')
        : this.module_number_video == 100
          ? i18n('pager.conclusao')
          : i18n('pager.modulo') + ' ' + this.module_number_video), h("div", { class: "box-modules d-flex" }, h("h1", { class: "col-12 col-lg-8 col-xxl-9", innerHTML: this.title_gallery }), h("div", { class: "module-navigation d-flex col-lg-4 col-xxl-3" }, h("div", { class: `module-button-navigation before`, id: "before", onClick: () => {
        this.prevScroll();
      } }, h("span", { class: "material-icons" }, "keyboard_arrow_left")), this.renderButtonsMenu(), h("div", { class: `module-button-navigation after`, id: "after", onClick: () => {
        this.nextScroll();
      } }, h("span", { class: "material-icons" }, "keyboard_arrow_right"))))), h("div", { class: "c-gallery-video__content" }, h("div", { class: "c-gallery-video__content_videos col-12 col-lg-8 col-xxl-9" }, h("div", { class: "close-modal d-lg-none d-xl-none d-sxl-none", onClick: () => {
        this.closeModalGallery();
      } }, h("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { d: "M13.3 0.709971C12.91 0.319971 12.28 0.319971 11.89 0.709971L6.99997 5.58997L2.10997 0.699971C1.71997 0.309971 1.08997 0.309971 0.699971 0.699971C0.309971 1.08997 0.309971 1.71997 0.699971 2.10997L5.58997 6.99997L0.699971 11.89C0.309971 12.28 0.309971 12.91 0.699971 13.3C1.08997 13.69 1.71997 13.69 2.10997 13.3L6.99997 8.40997L11.89 13.3C12.28 13.69 12.91 13.69 13.3 13.3C13.69 12.91 13.69 12.28 13.3 11.89L8.40997 6.99997L13.3 2.10997C13.68 1.72997 13.68 1.08997 13.3 0.709971Z", fill: "#fff" }))), h("div", { class: "c-gallery-video__content_videos_video" }, h("yduqs-video-player", { "skip-menu": "true", src: this.srcVideo, videoId: "", width: "", height: "" })), h("div", { class: "c-gallery-video__header d-inline d-lg-none" }, h("h5", null, this.module_number_video == 0
      ? i18n('pager.todos')
      : this.module_number_video == 99
        ? i18n('pager.apresentacao')
        : this.module_number_video == 100
          ? i18n('pager.conclusao')
          : i18n('pager.modulo') + ' ' + this.module_number_video), h("div", { class: "box-modules d-flex flex-column" }, h("h1", { class: "col-lg-8 col-xxl-9", innerHTML: this.title_gallery }), h("div", { class: "d-flex module-navigation-mob" }, h("div", { class: `module-button-navigation before-mob`, id: "before", onClick: () => {
        this.prevScroll();
      } }, h("span", { class: "material-icons" }, "keyboard_arrow_left")), this.renderButtonsMenu(), h("div", { class: `module-button-navigation after-mob`, id: "after", onClick: () => {
        this.nextScroll();
      } }, h("span", { class: "material-icons" }, "keyboard_arrow_right")))))), h("div", { class: "c-gallery-video__content_playlist col-12 col-lg-4 col-xxl-3" }, h("yduqs-playlist-video", { id: "playlist", module_number: this.module_number })))));
  }
...
export { GalleryVideo as yduqs_gallery_video, PlaylistVideo as yduqs_playlist_video };
