const HighlightOffIcon = {
	"name": "highlight_off",
	"content": "<svg viewBox=\"0 0 48 48\" xmlns=\"http://www.w3.org/2000/svg\" role=\"img\"><path d=\"M24 4C12.94 4 4 12.94 4 24s8.94 20 20 20 20-8.94 20-20S35.06 4 24 4zm8.58 25.78c.78.78.78 2.04 0 2.82-.78.78-2.04.78-2.82 0L24 26.82l-5.78 5.78c-.78.78-2.04.78-2.82 0-.78-.78-.78-2.04 0-2.82L21.18 24l-5.76-5.78c-.78-.78-.78-2.04 0-2.82.78-.78 2.04-.78 2.82 0L24 21.18l5.78-5.78c.78-.78 2.04-.78 2.82 0 .78.78.78 2.04 0 2.82L26.82 24l5.76 5.78z\" fill=\"inherit\"/></svg>"
};
