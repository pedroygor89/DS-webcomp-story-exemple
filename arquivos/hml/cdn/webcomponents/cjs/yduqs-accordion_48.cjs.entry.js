...
const YduqsAudioPlayer = class {
  ...
  render() {
    ...
    let audioScript = `
        ...
        `;
    return (index.h("div", { id: `audioPlayer` + this.audio_id, class: `c-audio-player ${shortPlayerClass}` }, index.h("audio", { class: "c-audio__object" }, index.h("source", { src: this.src, type: "audio/mpeg" }, "O seu navegador n\u00E3o suporta o elemento ", index.h("code", null, "audio"), ".")), index.h("script", null, audioScript)));
  }
...
const YduqsCardComparativo = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: `c-card-comparativo ${colorMode} ${outlineClass}` }, index.h("slot", { name: "item-a" }), index.h("div", { class: "c-card-comparativo__divider" }, index.h("div", { class: "c-card-comparativo__bar" }), index.h("div", { class: "c-card-comparativo__icon-container" }, index.h("span", { class: "c-card-comparativo__icon material-icons" }, this.icon ? this.icon : 'close'))), index.h("slot", { name: "item-b" })));
  }
};
