...
const PlaylistVideo = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "c-card-video " + styleBorder }, index.h("div", { class: "c-card-video__thumb" }, index.h("yduqs-image", { src: this.thumb_video, alt: "Fuji-san" }), index.h("div", { class: "c-card-video__thumb_play" }, index.h("span", { class: "material-icons" }, "play_arrow"))), index.h("div", { class: "c-card-video__description" }, index.h("h2", { class: "c-heading" }, this.title_video), index.h("p", { class: "c-paragraph" }, this.paragraph), index.h("div", { class: "c-card-video__description_time" }, this.time))));
  }
};
...
exports.yduqs_card_video = PlaylistVideo;
