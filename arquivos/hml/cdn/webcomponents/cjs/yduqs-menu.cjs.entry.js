  ...
  renderMenuMedia() {
    ...
    this.settings.modules.forEach((e, indexModule) => {
      ...
      if (modNum !== 'apresentacao' && modNum !== 'conclusao' && modNum !== 'introducao') {
        ...
        menuItemsList.push(index.h("yduqs-accordion", { id: 'menu-accordion-video-' + indexModule, outline: false }, index.h("yduqs-accordion-pane", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "menu:conteudo-clique-item", "data-gtm-event-label": 'submenu:video-' + modNum }, index.h("span", { slot: "c-accordion-header", innerHTML: modNum == 'apresentacao' ? this.renderNameModule(i18n.i18n('pager.apresentacao')) : modNum == 'conclusao' ? this.renderNameModule(i18n.i18n('pager.conclusao')) : this.renderNameModule(i18n.i18n('pager.modulo') + ' ' + modNum) }, index.h("p", { class: "module-subtitle-menu", innerHTML: (this._titleModuloCover && this._titleModuloCover[indexModule - 1]) || '' })), index.h("div", { slot: "c-accordion-content" }, ...menuSubItemsList))));
