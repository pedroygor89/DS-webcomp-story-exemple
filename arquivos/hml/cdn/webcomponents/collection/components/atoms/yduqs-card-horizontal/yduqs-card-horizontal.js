import { h, Component, Prop, State, Listen, getAssetPath } from '@stencil/core';
        ...
        h("header", null,
          ...
          h("div", { class: 'card-content row align-items-center justify-content-center g-0' },
            h("div", { class: 'col-sm-12 col-md-5 col-lg-5' }, !this.isquestion ?
              h("div", { class: "card-image", style: { "background-image": "url('" + (this.card_image ? this.card_image : imageDevice) + "')" } },
                h("img", { src: this.card_image ? this.card_image : imageDevice, alt: this.image_alt, title: this.image_title, loading: "lazy" }))
              :
