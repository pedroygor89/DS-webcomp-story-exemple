...
export class audioCard {
  ...
  render() {
    ...
    return [
      h("div", { class: `c-audio-card${group} ${background_audio_card}` },
        h("div", { class: "box" },
          h("slot", null)),
        h("yduqs-card", { id: this.audiocard_id, dark: this.dark, outlined: this.outlined, equal_height: this.equal_height },
          h("audio", { preload: "metadata", class: "audio-object", src: this.src, ref: (el) => this.audioPlayer = el }),
          h("h1", { class: `${title_dark} `, innerHTML: this.title_audio_card }),
          h("div", { class: "box-buttons" },
            h("button", { type: "button", class: `c-button ${btn_dark} `, onClick: () => this.playAudio() },
              h("span", { class: "c-button__icon material-icons-round play" }, this.isPlaying ? 'stop' : 'play_arrow')),
