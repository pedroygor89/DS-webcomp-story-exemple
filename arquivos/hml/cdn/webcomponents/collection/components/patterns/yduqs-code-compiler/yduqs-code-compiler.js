        ...
        h("div", { class: "box" },
          ...
          h("div", { class: "box-input-console" },
            h("div", { class: "box-input" },
              ...
              h("div", { class: "content_input" },
                h("textarea", { value: this.formatValue(this.value), onInput: (event) => this.handleChange(event) }))),
              ...
              h("yduqs-tabs", { darkmode: false },
                h("yduqs-tab", { header: "Input", open: true },
                  h("div", { class: "box-input-tab" },
                    h("div", { class: "content_input-tab" },
                      h("textarea", { value: this.formatValue(this.value), onInput: (event) => this.handleChange(event) })))),
                h("yduqs-tab", { header: "Console" },
                  h("div", { class: "box-console-tab" }, this.response_active ?
