...
export class Footer {
    ...
    return (h(Host, null,
      h("div", { class: "c-footer-bgColor" },
        h("div", { class: "container" },
          this.template_anitta ? (h("yduqs-title", { topic_title: "Backstage" })) : (h("yduqs-title", { topic_title: this.english ? 'References' : this.spanish ? 'Referencias' : 'Referências' })),
          ...
          this.template_anitta ? (h("yduqs-title", { topic_title: "Explore +" })) : (h("yduqs-title", { topic_title: this.english ? 'Go Further' : this.spanish ? 'Explora +' : 'Explore +' })),
          h("div", { class: "row align-items-center justify-content-center" },
            h("div", { class: "col-12 col-md-10 col-lg-8" },
              ...
              h("div", { class: "d-flex justify-content-center align-items-center" },
                h("div", null,
                  h("a", { href: `javascript:${this.hrefbtnprint}`, class: `c-button ${!this.btnimprimir ? 'disableText' : ''}` },
                    ...
                    ' '))))))),
      !this.hide_pagination && h("yduqs-pager", { id: "pager" }),
      !this.hide_motivational_messages && h("yduqs-motivational-messages", { id: "global-messages" })));
  }
  ...
  static get properties() { return {
    ...
    "hide_pagination": {
      ...
      "attribute": "hide_pagination",
      "reflect": false,
      "defaultValue": "false"
    },
    "hide_motivational_messages": {
      "type": "boolean",
      "mutable": false,
      "complexType": {
        "original": "boolean",
      ...
      "attribute": "hide_motivational_messages",
      "reflect": false,
      "defaultValue": "false"
    }
  }; }
