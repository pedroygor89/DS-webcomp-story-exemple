...
export class YduqsOrderedDndChallenge {
  ...
  getResultThumb(item, index) {
    ...
    return (h("div", { class: `item ${result ? 'success' : 'error'}` },
      h("img", { src: item === null || item === void 0 ? void 0 : item.thumb, alt: "" }),
      h("i", { class: `material-icons icon ${result ? 'success' : 'error'}` }, result ? 'sentiment_very_satisfied' : 'sentiment_dissatisfied')));
  }
  startTutorial() {
    this.showInfo = false;
    this.tutorialItem = 'chances';
    ...
    return (h(Host, { class: `c-lab-game c-ordered c-ordered-challenge step-${this.step}`, ref: ref => (this.hostElem = ref) }, this.step !== _STEP_.LOADING ? (h(Fragment, null,
      ...
      this.step === _STEP_.FEEDBACK && (h("yduqs-modal", { variant: "lab", size: "small", id: `${this._id}-feedback-modal`, isopen: true },
        h("div", { class: "c-lab-game-modal-feedback" }, this.showFeedback === 'positive' ? (h(Fragment, null,
          ...
          ((_g = this.selecteds) === null || _g === void 0 ? void 0 : _g.length) > 0 && ((_h = this.selecteds) === null || _h === void 0 ? void 0 : _h.length) === this.sequence.length ? (h(Fragment, null,
            h("div", { class: "content" },
            ...
            h("p", null, "Foi por pouco! Voc\u00EA n\u00E3o finalizou a atividade a tempo e perdeu uma vida."),
            " ",
            (this.usedChances + 1 === this.chances) && (h("p", null, this.failFeedback)))),
          h("footer", null,
