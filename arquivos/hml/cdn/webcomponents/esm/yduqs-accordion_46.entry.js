...
const YduqsBeforeAfter = class {
  ...
  async changeImage() {
    ...
    this.img = document.querySelector(".images .img2");
    this.dragLine = document.querySelector(".slider .drag-line");
    this.slider.addEventListener('input', () => {
      this.sliderval = this.slider.value;
      this.dragLine.style.left = this.sliderval + '%';
      this.calc_width = (this.img.width * this.sliderval) / 100 + 'px';
      this.img.style.clip = `rect(0px ${this.calc_width} auto 0px)`;
    });
  }
  componentDidLoad() {
    window.addEventListener('appload', () => {
      this.width = document.querySelector('.images .img2');
      if (this.width.clientWidth > 0) {
        this.width.style.clip = 'rect(0px ' + (this.width.clientWidth / 2) + 'px auto 0px)';
      }
    });
  }
  render() {
    return (h("div", { class: "c-before-after" }, h("div", { class: "row-ba pb-1" }, h("div", { class: "container-ba" }, h("div", { class: "wrapper" }, h("div", { class: "images" }, h("img", { class: "img1", src: this.after_img }), h("img", { class: "img2", src: this.before_img, style: { "clip": `rect(0px 0px auto 0px)` } })), h("div", { class: "slider" }, h("div", { class: "drag-line" }, h("span", null)), h("input", { type: "range", min: "0", max: "100", value: "50", onInput: this.changeImage }))), h("div", { class: "caption-before-after" }, h("p", { class: "c-before-after__caption u-text--small mt-2" }, this.caption))))));
  }
};
...
const Textarea = class {
  ...
  async colaboradores() {
    ...
    console.log(this.colaboradores_nome);
  }
  componentWillRender() {
    this.curadores();
    this.colaboradores();
...
const Rating = class {
  ...
  render() {
    return (h("div", { class: "c-rating" }, h("h3", null, this.cta), h("div", { class: "star-rating" }, h("label", null, h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), h("label", null, h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), h("label", null, h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), h("label", null, h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon)), h("label", null, h("i", { class: `active material-icons ${this.tamanho}`, "aria-hidden": "true" }, this.icon))), this.dev ?
      h("script", { src: "https://stensineme.blob.core.windows.net/designsystem/test/yduqs_rating_dev.js" })
      : ''));
  }
};
