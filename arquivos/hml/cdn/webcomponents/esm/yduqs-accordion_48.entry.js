import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-ce0ed2ab.js';
...
const YduqsAudioPlayer = class {
  ...
  render() {
    ...
    let audioScript = `
        ...
        `;
    return (h("div", { id: `audioPlayer` + this.audio_id, class: `c-audio-player ${shortPlayerClass}` }, h("audio", { class: "c-audio__object" }, h("source", { src: this.src, type: "audio/mpeg" }, "O seu navegador n\u00E3o suporta o elemento ", h("code", null, "audio"), ".")), h("script", null, audioScript)));
  }
...
const YduqsCardComparativo = class {
  ...
  render() {
    ...
    return (h(Host, { class: `c-card-comparativo ${colorMode} ${outlineClass}` }, h("slot", { name: "item-a" }), h("div", { class: "c-card-comparativo__divider" }, h("div", { class: "c-card-comparativo__bar" }), h("div", { class: "c-card-comparativo__icon-container" }, h("span", { class: "c-card-comparativo__icon material-icons" }, this.icon ? this.icon : 'close'))), h("slot", { name: "item-b" })));
  }
};
