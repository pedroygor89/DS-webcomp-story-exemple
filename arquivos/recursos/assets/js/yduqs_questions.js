        ...
        if (hasFinalAnswer == undefined) {
            ...
            if (btnTryAgain == false) {
                ...
                if (chosenNumber == question_answers[questionNumber]) {
                    ...
                    /*$(".c-module-rating").addClass('open-rating');
...
//Encontra cada bloco de perguntas e executa:
    ...
    console.log(htmlLanguageGallery)
    ...
    const txtLanguageAltenatives = english ? 'Oops, you have to choose one option' : spanish ? 'Vaya! Debes elegir una alternativa' : 'Escolha uma alternativa'



    $('body').append(`<yduqs-notification id="question-warning" dismissible type="warning">${txtLanguageAltenatives}</yduqs-notification>`);
