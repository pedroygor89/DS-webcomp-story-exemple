    ...
    $(this).on("click", function () {
        ...
        if (hasFinalAnswer == undefined) {
            ...
            if (btnTryAgain == false) {
                ...
                let feedbackClass = document.getElementsByClassName('question-positive-feedback')
                let feedbackClassToArray = Array.from(feedbackClass)
                ...
                if (chosenNumber == question_answers[questionNumber]) {
                    ...
                    if (typeof isExercise !== typeof undefined && isExercise !== false) {
                        ...
                        var checkPf = decodeURIComponent(positiveFeedbacks[questionNumber]);
                        ...
                        if (checkPf === 'undefined') {
                            ...
                            <div class="containerPositiveFeedbackExercise">
                                <yduqs-card-destaque grade="2" outline="false" icon="check_circle">
                                    <yduqs-card-destaque-header>
                                        <h2 class="c-heading u-large mb-5">Parabéns! A alternativa <span class="text-uppercase">${finalAnswer}</span> está correta.</h2>
                                    </yduqs-card-destaque-header>
                                </yduqs-card-destaque>
                            </div>
                        `);
                        ...
                        //feedbackClass.classList.add("exerciseWidth")
                          ...
                          <yduqs-card-destaque-body>
                                <p class="c-paragraph">${decodeURIComponent(positiveFeedbacks[questionNumber])}</p>
                            </yduqs-card-destaque-body>   </yduqs-card-destaque-header>
                    ...
                    if (typeof isExercise !== typeof undefined && isExercise !== false) {
                        ...
                        feedbackNegativeLocation.html(`
                            <div class="containerNegativeFeedbackExercise">
