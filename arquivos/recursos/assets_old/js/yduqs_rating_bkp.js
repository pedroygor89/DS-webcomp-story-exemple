...
function rate_mod(modNota) {
    ...
    if (nota == 1) {
        mod_star_label.each(function (index) {
            mod_star.html(`
                <label id="mod${modulo}_nota5" onclick="rate_mod('${modulo}-5'${star_empty}
                <label id="mod${modulo}_nota4" onclick="rate_mod('${modulo}-4'${star_empty}
                <label id="mod${modulo}_nota3" onclick="rate_mod('${modulo}-3'${star_empty}
                <label id="mod${modulo}_nota2" onclick="rate_mod('${modulo}-2'${star_empty}
                <label id="mod${modulo}_nota1" onclick="rate_mod('${modulo}-1'${star_full}
            `);
        });
    ...
    if (nota == 2) {
        mod_star_label.each(function (index) {
            mod_star.html(`
                ...
                <label id="mod${modulo}_nota4" onclick="rate_mod('${modulo}-4'${star_empty}
                <label id="mod${modulo}_nota3" onclick="rate_mod('${modulo}-3'${star_empty}
                <label id="mod${modulo}_nota2" onclick="rate_mod('${modulo}-2'${star_full}
                <label id="mod${modulo}_nota1" onclick="rate_mod('${modulo}-1'${star_full}
            `);
        });
        window['mod' + modulo + 'nota'] = nota;
    ...
    if (nota == 3) {
        mod_star_label.each(function (index) {
            mod_star.html(`
                <label id="mod${modulo}_nota5" onclick="rate_mod('${modulo}-5'${star_empty}
                <label id="mod${modulo}_nota4" onclick="rate_mod('${modulo}-4'${star_empty}
                <label id="mod${modulo}_nota3" onclick="rate_mod('${modulo}-3'${star_full}
                <label id="mod${modulo}_nota2" onclick="rate_mod('${modulo}-2'${star_full}
                <label id="mod${modulo}_nota1" onclick="rate_mod('${modulo}-1'${star_full}
            `);
        });
    ...
    if (nota == 4) {
        mod_star_label.each(function (index) {
            mod_star.html(`
                <label id="mod${modulo}_nota5" onclick="rate_mod('${modulo}-5'${star_empty}
                <label id="mod${modulo}_nota4" onclick="rate_mod('${modulo}-4'${star_full}
                <label id="mod${modulo}_nota3" onclick="rate_mod('${modulo}-3'${star_full}
                <label id="mod${modulo}_nota2" onclick="rate_mod('${modulo}-2'${star_full}
                <label id="mod${modulo}_nota1" onclick="rate_mod('${modulo}-1'${star_full}
            `);
    ...
    if (nota == 5) {
        mod_star_label.each(function (index) {
            mod_star.html(`
                <label id="mod${modulo}_nota5" onclick="rate_mod('${modulo}-5'${star_full}
                <label id="mod${modulo}_nota4" onclick="rate_mod('${modulo}-4'${star_full}
                <label id="mod${modulo}_nota3" onclick="rate_mod('${modulo}-3'${star_full}
                <label id="mod${modulo}_nota2" onclick="rate_mod('${modulo}-2'${star_full}
                <label id="mod${modulo}_nota1" onclick="rate_mod('${modulo}-1'${star_full}
