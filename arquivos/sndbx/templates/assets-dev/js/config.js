...
function checkMathJax(type, full) {
    ...
    if (assetsMath === null && wcMath === null && yqMath === null) {
        ...
        if (document.body.classList.contains('template_recursos')) {
            ...
            scriptTag.src = `https://stensineme.blob.core.windows.net/assets/js/mathjax/es5/${window['mathJaxUrl']}`;
        }
...
function reloadMath() {
    ...
    if (assetsMath !== null || wcMath !== null || yqMath !== null) {
        ...
        if (document.body.classList.contains('template_recursos')) {
            ...
            reloadMath.src = "https://stensineme.blob.core.windows.net/assets/js/yduqs_mathjax_reload.min.js";
        }
