if ((document.URL.includes("stensineme") && (document.URL.includes("hmlgrepoh")))) {
                            ...
                            <div class="row g-0">                                       
                                <div class="col-md-12" style="margin: 0px; padding: 0px 5px; font-size: 12px;">
                                    <div class="card-body">
                                        <p class="card-text mt-0 mb-0" style="color:white" >
                                            <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 15px;">task_alt</span> PARABÉNS</strong>
                                            <br> As capas estão com a largura e altura adequada!
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">                                       
                                <div class="col-md-12" style="margin: 0px; padding: 0px 5px; font-size: 12px;">
                                    <div class="card-body">
                                        <p class="card-text mt-0 mb-0" style="color:white" >
                                            <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 15px;">task_alt</span> PARABÉNS</strong>
                                            <br> Todas as imagens estão com o peso adequado!
                                        </p>
                                    </div>
                                </div>
                            </div>
    ...
    function mainFun() {
        ...
        var countErro = 0,
            ...
            coverErro = 0,
            carouselErro = 0,
            carouselHorizontalErro = 0,
            countErroCard = 0,
            moduleErro = 0,
            quodeErro = 0;
        cardComparativoErro = 0;
        var amtImageCover = 0,
            amtImageCarouselHorizontal = 0,
            amtImageCarousel = 0,
            amtImageModule = 0,
            amtImageQuote = 0,
            amtImageTemplate = 0;
        amtCardComparativo = 0;
        ...
        if (document.body.contains(document.querySelector('yduqs-cover'))) {
            ...
            if (widthImageCover > 2585 && heightImageCover > 1138) {
                msgCover = `
                <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                    <div class="row g-0">
                        <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                            <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do tema possui largura superior a <strong>2582px</strong> e altura superior à <strong>1138px</strong> . 
                ...
                <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                            <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do tema possui largura superior à <strong>2585px</strong>. 
                            <br>- <strong >Tamanho</strong>: ${widthImageCover} x ${heightImageCover} px 
                            <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCover}" target="_blank"> link da imagem</a>
                            </p>
                ...
                <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                            <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do tema possui altura superior à <strong>1138px</strong>. 
                            <br>- <strong>Tamanho</strong>: ${widthImageCover} x ${heightImageCover} px 
                            <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCover}" target="_blank"> link da imagem</a>
                            </p>
        ...
        if (document.body.contains(document.querySelector('yduqs-module-cover'))) {
            ...
            for (var i = 0; i < allModule.length; i++) {
                ...
                if (widthImageModule > 1130 && heightImageModule > 1011) {
                    msgModule = `
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do módulo ${moduloNumber} tem largura superior a <strong>1130px</strong> e altura superior à <strong>1011px</strong> . 
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do módulo ${moduloNumber} tem largura superior à <strong>1130px</strong>. 
                                <br>- <strong >Tamanho</strong>: ${widthImageModule} x ${heightImageModule} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlModule}" target="_blank"> link da imagem</a>
                                </p>
                ...
                } else if (heightImageModule > 1011) {
                    msgModule = `
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a capa do módulo ${moduloNumber} tem altura superior à <strong>1011px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthImageModule} x ${heightImageModule} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlModule}" target="_blank"> link da imagem</a>
                                </p>
        ...
        if (document.body.contains(document.querySelector('.c-card-comparativo__image'))) {
            ...
            for (var i = 0; i < allCardComparative.length; i++) {
                ...
                if (widthCardComparative > 379) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do card comparativo possui largura superior à <strong>379px</strong>. 
                ...
                } else if (heightCardComparative > 379) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do card comparativo possui altura superior à <strong>379px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthCardComparative} x ${heightCardComparative} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCardComparative}" target="_blank"> link da imagem</a>
                                </p>
                    ...
                    imgCard.push(msgCard);
                    countErroCard += 1;
                } else if (heightCardComparative > 379 && widthCardComparative > 379) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;" ><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do card comparativo possui largura e altura superior à <strong>379px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthCardComparative} x ${heightCardComparative} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCardComparative}" target="_blank"> link da imagem</a>
                                </p>
        ...
        if (document.body.contains(document.querySelector('.c-carousel-item__img-container img'))) {
            ...
            var allCarouselHorizontal = document.querySelectorAll('.c-carousel-item__img-container img');
            ...
            for (var i = 0; i < allCarouselHorizontal.length; i++) {
                ...
                if (widthCarouselHorizontal > 854) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do carousel vertical tem largura superior a <strong>854px</strong>. 
        ...
        if (document.body.contains(document.querySelector('.c-carousel-item__img-container--vertical img '))) {
            var allCarrosel = document.querySelectorAll('.c-carousel-item__img-container--vertical img ')
            ...
            for (var i = 0; i < allCarrosel.length; i++) {
                ...
                if (widthCarrosel > 413 && heightCarrosel > 678) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do carousel horizontal tem largura superior a <strong>413px</strong> e largura da imagem e superior à <strong>678px</strong> . 
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do carousel horizontal tem largura <strong>413px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthCarrosel} x ${heightCarrosel} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCarousel}" target="_blank"> link da imagem</a>
                                </p>
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do carousel horizontal tem altura superior a <strong>679px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthCarrosel} x ${heightCarrosel} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlCarousel}" target="_blank"> link da imagem</a>
                                </p>
        ...
        if (document.body.contains(document.querySelector('.c-quote__image'))) {
            ...
            for (var i = 0; i < allQuote.length; i++) {
                ...
                if (widthImageQuote > 415 && heightImageQuote > 700) {
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do Quote tem largura superior a <strong>415px</strong> e altura superior à <strong>700px</strong> . 
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do Quote tem largura superior à <strong>415px</strong>. 
                                <br>- <strong >Tamanho</strong>: ${widthImageQuote} x ${heightImageQuote} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlQuote}" target="_blank"> link da imagem</a>
                                </p>
                    ...
                    <div class="card mb-3 p-2" style="max-width: 100%; background-color: #f35252; border-radius: 5px;" >
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                <p class="card-text mt-0 mb-0" style="padding-left: 10px; color:white" >
                                <strong style="font-size: 15px;"><span class="material-icons" style="font-size: 20px; vertical-align: sub;">error_outline</span> ATENÇÃO</strong>: a imagem do Quote tem altura superior à <strong>700px</strong>. 
                                <br>- <strong>Tamanho</strong>: ${widthImageQuote} x ${heightImageQuote} px 
                                <br>- <strong>URL da imagem</strong>: <a style="color: var(--colors-tema-accent-30);" href="${urlQuote}" target="_blank"> link da imagem</a>
                                </p>
        ...
        if (allimage < 1) {
            ...
            elParagraph.innerHTML = "Parabéns não foram identificados ajustes!";
