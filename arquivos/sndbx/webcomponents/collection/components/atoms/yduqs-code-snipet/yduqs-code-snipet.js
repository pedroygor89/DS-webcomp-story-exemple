    ...
    return [
      h("div", { class: `c-code-snipet ${this.isDark ? 'dark' : ''}` },
        h("div", { class: "top d-flex align-items-center justify-content-between" },
          ...
          h("span", { class: "material-icons icon", onClick: () => this.copy(decodeURIComponent(this.code)) }, "content_copy")),
        h("div", { class: `box box-${this.size}` },
          h("div", { class: "box-code" },
            h("my-stace", { class: "content_code", mode: this.language_code, theme: `${this.isDark ? 'monokai' : 'chrome'}`, readOnly: true, autoUpdateContent: false, durationBeforeCallback: 1000 }, decodeURIComponent(this.code)))))
    ];
  }
