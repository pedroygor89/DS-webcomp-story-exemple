...
const Template = ({ tab1, contentTab1, tab2, contentTab2, tab3, contentTab3, tab4, contentTab4, darkmode, outlined }) => html `
  <div class="container">
    <yduqs-tabs darkmode="${darkmode}" outlined="${outlined}" >
