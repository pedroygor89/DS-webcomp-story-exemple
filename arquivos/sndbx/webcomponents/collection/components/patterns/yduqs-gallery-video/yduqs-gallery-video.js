  ...
  render() {
    return (h("div", { class: "c-gallery-video" },
      h("div", { class: "c-gallery-video__header d-none d-lg-inline" },
        h("h5", null, this.module_number_video == 0 ? i18n('pager.todos') : this.module_number_video == 99 ? i18n('pager.apresentacao') : this.module_number_video == 100 ? i18n('pager.conclusao') : i18n('pager.modulo') + ' ' + this.module_number_video),
        h("div", { class: "box-modules d-flex" },
          ...
          h("div", { class: "module-navigation d-flex col-lg-4 col-xxl-3" },
            h("div", { class: `module-button-navigation before`, id: "before", onClick: () => { this.prevScroll(); } },
              h("span", { class: "material-icons" }, "keyboard_arrow_left")),
            this.renderButtonsMenu(),
            h("div", { class: `module-button-navigation after`, id: "after", onClick: () => { this.nextScroll(); } },
      ...
      h("div", { class: "c-gallery-video__content" },
        h("div", { class: "c-gallery-video__content_videos col-12 col-lg-8 col-xxl-9" },
          h("div", { class: "close-modal d-lg-none d-xl-none d-sxl-none", onClick: () => { this.closeModalGallery(); } },
          ...
          h("div", { class: "c-gallery-video__header d-inline d-lg-none" },
            ...
            h("div", { class: "box-modules d-flex flex-column" },
              ...
              h("div", { class: "d-flex module-navigation-mob" },
                h("div", { class: `module-button-navigation before-mob`, id: "before", onClick: () => { this.prevScroll(); } },
                  h("span", { class: "material-icons" }, "keyboard_arrow_left")),
                this.renderButtonsMenu(),
                h("div", { class: `module-button-navigation after-mob`, id: "after", onClick: () => { this.nextScroll(); } },
                  h("span", { class: "material-icons" }, "keyboard_arrow_right")))))),
