  ...
  render() {
    ...
    return [
      h("div", { class: 'c-module-cover' },
        h("div", { class: 'd-flex flex-column flex-lg-row' },
          h("div", { class: "d-flex justify-content-center align-items-center box-column d-lg-block" },
            h("span", null),
            h("p", { class: "u-title-medium" }, this.number_module),
            h("span", null)),
          h("div", { class: "container-fluid d-flex flex-column flex-lg-row g-0" },
