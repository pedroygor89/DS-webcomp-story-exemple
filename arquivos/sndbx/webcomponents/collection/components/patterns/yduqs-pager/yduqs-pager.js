...
import { cleanString, dispatchEvent } from '../../../utils/utils';
export class YduqsPager {
  constructor() {
  ...
  _getLabelModule(module, count) {
    return (h("div", { class: "c-pager-label-module", "data-cy": `${module}-${count}` },
      h("span", { class: "c-pager-label-module-text", "data-cy": module }, module),
      Boolean(count === null || count === void 0 ? void 0 : count.length) && (h("span", { class: "c-pager-label-module-count", "data-cy": count }, count))));
  }
  _getLabel() {
    ...
    if (isNaN(Number(moduleCount))) {
      ...
      if (pageElem.get(0).tagName === 'YDUQS-MODULE-COVER') {
        ...
        result = (h("div", { class: "c-pager-label-container", "data-cy": label },
          h("div", { class: "c-pager-label-page" },
            h("span", { class: "c-pager-label-page-text", "data-cy": `label ${label}` }, this.getTexts(label || 'conceito')),
            h("span", { class: "c-pager-label-page-count" },
              h("strong", { "data-cy": "count-atual" }, config.atual),
              " / ",
              h("strong", { "data-cy": "count-total" }, config.total))),
          h("div", { class: "c-pager-label-separator" }, "|"),
          this._getLabelModule(this.getTexts('modulo'), moduleCount)));
      }
    }
    return result;
  }
  ...
  render() {
    return (h(Host, null,
      h("div", { class: `c-pager ${this.total <= 1 ? 'c-pager-none' : ''}`, id: "btnPaginator" },
        h("button", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "paginacao:conteudo-clique-botao", "data-gtm-event-label": "voltar", disabled: true, type: "button", class: "c-button c-button__icon-container c-button__icon-square", "data-cy": "btn-prev", ref: el => (this.btnPrev = el), onClick: () => this._goToPrev() },
          h("span", { class: "c-button__icon material-icons" }, "arrow_back")),
        this._getLabel(),
        h("button", { "data-gtm-event-category": "joana:[[instituicao]]:[[tipo-usuario]]", "data-gtm-event-action": "paginacao:conteudo-clique-botao", "data-gtm-event-label": "avancar", type: "button", class: "c-button c-button__icon-container c-button__icon-square", "data-cy": "btn-next", ref: el => (this.btnNext = el), onClick: () => this._goToNext() },
          h("span", { class: "c-button__icon material-icons" }, "arrow_forward")))));
  }
  static get is() { return "yduqs-pager"; }
