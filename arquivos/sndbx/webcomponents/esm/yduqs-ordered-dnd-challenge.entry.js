...
const YduqsOrderedDndChallenge = class {
  ...
  render() {
    ...
    })))), this.step === _STEP_.FEEDBACK && (h("yduqs-modal", { variant: "lab", size: (this.showFeedback != 'positive' && ((_g = this.selecteds) === null || _g === void 0 ? void 0 : _g.length) > 0 && ((_h = this.selecteds) === null || _h === void 0 ? void 0 : _h.length) === this.sequence.length) ? 'large' : 'small', id: `${this._id}-feedback-modal`, isopen: true }, h("div", { class: "c-lab-game-modal-feedback" }, this.showFeedback === 'positive' ? (h(Fragment, null, h("div", { class: "content" }, h("yduqs-feedback-thumb", { class: "thumb", feedback: true, image: this.selecteds[0].image }), h("p", null, this.positiveFeedback)), h("footer", null, h("button", { type: "button", class: "c-button", onClick: () => this.handleCloseFeedback() }, "Continuar")))) : (h(Fragment, null, ((_j = this.selecteds) === null || _j === void 0 ? void 0 : _j.length) > 0 && ((_k = this.selecteds) === null || _k === void 0 ? void 0 : _k.length) === this.sequence.length ? (h(Fragment, null, h("div", { class: "content" }, h("p", null, (this.usedChances + 1 === this.chances) ? this.failFeedback : this.negativeFeedback)), h("div", { class: "result" }, this.selecteds.map((item, index) => this.getResultThumb(item, index))))) : (h("div", { class: "content" }, h("p", null, "Foi por pouco! Voc\u00EA n\u00E3o finalizou a atividade a tempo e perdeu uma tentativa."), " ")), h("footer", null, h("button", { type: "button", class: "c-button", onClick: () => this.handleCloseFeedback() }, (this.usedChances + 1 === this.chances) ? 'Voltar para Teoria' : 'Tentar outra vez'))))))))) : (h("yduqs-lab-error", { errors: this.error }))));
  }
};
